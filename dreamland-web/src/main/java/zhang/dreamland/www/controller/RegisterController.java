...
import zhang.dreamland.www.common.CodeCaptchaServlet;
import zhang.dreamland.www.common.MD5Util;
import zhang.dreamland.www.entity.User;
import zhang.dreamland.www.mail.SendEmail;
...
public class RegisterController {
    ...
    public String active(Model model){
        ...
        if (userTrue!=null && "1".equals(userTrue.getState())){
            //已激活
            model.addAttribute("fail","你已激活吗，请直接登录！");
            return "../login";
        }
        if(code==null){
            //激活码过期
